...
#### 1. Hexagonal Cap Screw or Hexagonal Bolt
A hex cap screw is a cap screw with a hexagonal head, designed to be driven by a wrench. A hexagonal cap screw has somewhat tighter tolerances than a hex bolt for the head height and the shank length. A hex cap screw will always fit where a hex bolt is installed, but a hex bolt could be slightly too large to be used where a hex cap screw is designed.

<div align="center">
  <img src="https://raw.githubusercontent.com/virtual-labs/exp-screwhead-applications-dei/a1155c39f85e1820ed2061e78bb66de3089fc825/experiment/HexagonalBolt.png" alt="Hexagonal Bolt" width="400">
  <br>
  <b>Figure: Hexagonal cap screw or Hexagonal Bolt</b>
</div>

#### 2. Phillips Screw Head
A Phillips screw is a fastener with a tapered threaded shank and a slotted (cross-shaped) head designed to prevent over-tightening.
...
Screw threads are defined by the following key parameters:

* **Lead:** The lead is defined as the linear distance the screw travels in one complete revolution ($360^\circ$) of the shaft. The lead determines the mechanical advantage; the smaller the lead, the higher the mechanical advantage.
